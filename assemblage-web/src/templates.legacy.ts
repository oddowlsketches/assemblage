...
export const templates: Template[] = [
  {
    ...
    placements: [
      { maskName: "architectural/archClassical", x: 0.10, y: 0.50, width: 0.25, height: 0.40 },
      { maskName: "architectural/archClassical", x: 0.50, y: 0.50, width: 0.25, height: 0.40 },
      { maskName: "architectural/archClassical", x: 0.90, y: 0.50, width: 0.25, height: 0.40 }
    ],
    defaultBG: "#eeeeee"
  },
  {
  ...
  },
  {
    ...
    params: {
      ...
      revealPct: { type: 'number', min: 40, max: 90, default: 75 },
      pattern: { type: 'select', options: ['random', 'clustered', 'silhouette', 'portrait'], default: 'random' },
      cellShape: { type: 'select', options: ['square', 'hStripe', 'vStripe', 'circle'], default: 'square' },
