...
const PRESETS = {
  classic: [
    { maskName: 'arch', x: 0.3, y: 0.2, width: 0.4, height: 0.5 },
    { maskName: 'window', x: 0.1, y: 0.3, width: 0.2, height: 0.3 },
    { maskName: 'window', x: 0.7, y: 0.3, width: 0.2, height: 0.3 },
    { maskName: 'column', x: 0.05, y: 0.2, width: 0.1, height: 0.7 },
    { maskName: 'column', x: 0.85, y: 0.2, width: 0.1, height: 0.7 },
    { maskName: 'cornice', x: 0.1, y: 0.1, width: 0.8, height: 0.1 }
  ],
  modern: [
    { maskName: 'window', x: 0.2, y: 0.2, width: 0.6, height: 0.6 },
    { maskName: 'door', x: 0.4, y: 0.6, width: 0.2, height: 0.3 },
    { maskName: 'cornice', x: 0.1, y: 0.1, width: 0.8, height: 0.05 }
  ],
  gothic: [
    { maskName: 'arch', x: 0.3, y: 0.1, width: 0.4, height: 0.6 },
    { maskName: 'window', x: 0.1, y: 0.3, width: 0.2, height: 0.4 },
    { maskName: 'window', x: 0.7, y: 0.3, width: 0.2, height: 0.4 },
    { maskName: 'column', x: 0.05, y: 0.2, width: 0.08, height: 0.7 },
    { maskName: 'column', x: 0.87, y: 0.2, width: 0.08, height: 0.7 },
    { maskName: 'cornice', x: 0.1, y: 0.05, width: 0.8, height: 0.15 }
  ]
};
