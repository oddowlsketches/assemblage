...
-- Allow public to read collections (drop and recreate to be safe)
...
-- Add updated_at trigger for image_collections (drop and recreate to be safe)
DROP TRIGGER IF EXISTS handle_image_collections_updated_at ON public.image_collections;
